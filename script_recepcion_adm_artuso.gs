/**
 * Script para la casilla: recepcion.adm.artuso@gmail.com
 * - Crear proyecto de Apps Script logueado como recepcion.adm.artuso@gmail.com
 * - Pegar este código en Code.gs
 * - Ejecutar ejecutarPrueba() para autorizar
